...
alias gcc='clang'
alias sshmini='ssh boater@ubuntu-mini'
alias sshimac='ssh bryantboatright@Bryants-iMac'
alias sshmacbookNew='ssh bryantboatright@bryants-macbook'
alias sshmacbookUbuntu='ssh boater@boater-old-macbook'
alias nf='neofetch'
