...
bindsym $mod+j workspace $ws5
bindsym $mod+k workspace $ws6
...
bindsym $mod+Shift+j move container to workspace $ws5; workspace $ws5
bindsym $mod+Shift+k move container to workspace $ws6; workspace $ws6
bindsym $mod+Shift+l move container to workspace $ws7; workspace $ws7
bindsym $mod+Shift+semicolon move container to workspace $ws8; workspace $ws8
